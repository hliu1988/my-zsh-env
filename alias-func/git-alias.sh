...
alias gb='git branch'
# alias gbvr='git branch -v --sort=-committerdate' # desc
# alias gbv='git branch -v --sort=committerdate'
alias gbvr='git for-each-ref --sort=-committerdate refs/heads/ --format="%(HEAD) %(color:yellow)%(refname:short)%(color:reset) - %(color:red)%(objectname:short)%(color:reset) - %(contents:subject) - %(authorname) (%(color:green)%(committerdate:relative)%(color:reset))"'
...
# alias gbgd='local res=$(gbg | awk '\''{print $1}'\'') && [[ $res ]] && echo $res | xargs git branch -d'
alias gbkp='git add .; git commit -m "backup"; git pull --rebase; git push'
...
alias gl='git pull'
alias glf='git log --stat --format=fuller'
alias glg='git log --stat'
alias glgg='git log --graph'
alias glgga='git log --graph --decorate --all'
alias glgm='git log --graph --max-count=10'
alias glgp='git log --stat --patch'
alias glo='git log --pretty='\''%Cred%h%Creset -%C(auto)%d%Creset %s %C(green)(%ad) %C(bold blue)<%an>%Creset'\'' --date=short --abbrev=8'
alias gloa='git log --pretty='\''%Cred%h%Creset -%C(auto)%d%Creset %s %C(cyan)(%cd) %C(green)(%ad) %C(bold blue)<%an>%Creset'\'' --date=short --abbrev=8'
...
alias glon='git log --oneline --decorate --pretty=format:"%h %Cblue%ad%Creset %an %Cgreen%s%Creset" --date=short'
...
gbk() {
  git add .
  [ $# -gt 0 ] && git commit -m "$*" || git commit -m "backup"
}
